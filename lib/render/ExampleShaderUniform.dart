...
class ExampleShaderUniform extends StatefulWidget {
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<ExampleShaderUniform> {
  ...
  render() {
    ...
    double greenValue = sin(current) / 2.0 + 0.5;
    int vertexColorLocation = gl.getUniformLocation(glProgram,"ourColor");
