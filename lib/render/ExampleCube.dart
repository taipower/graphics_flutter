...
class _MyAppState extends State<ExampleCube> {
  ...
  render() {
    ...
    math.Vector3 axis = math.Vector3(0.0, 0.0, 0.5);
    final model = math.Matrix4.identity()..rotate(axis, current.toDouble());
    final view = math.Matrix4.identity()..translate(math.Vector3(-4.0,-4.0,-4.0));
