...
class ExampleLightDiffuse extends StatefulWidget {
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<ExampleLightDiffuse> {
  ...
  render() {
    ...
    gl.uniform3f(gl.getUniformLocation(glProgram,'objectColor'),1.0,0.5,0.31);
    gl.uniform3f(gl.getUniformLocation(glProgram,'lightColor'),1.0,1.0,1.0);
