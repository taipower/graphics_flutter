...
class ExampleColorAtVertex extends StatefulWidget {
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<ExampleColorAtVertex> {
  ...
  render() {
    ...
    num _blue = sin((current - t) / 500);
    // Clear canvas
    gl.clearColor(1.0, 0.0, _blue, 1.0);
...
void main() {
  ...
  initVertexBuffers(gl) {
    ...
    var vertices = Float32Array.fromList([
      -0.5, -0.5, 0, 1.0, 0.0, 0.0, // Vertice #2
      0.5, -0.5, 0, 0.0, 1.0, 0.0, // Vertice #3
      0, 0.5, 0, 0.0, 0.0, 1.0, // Vertice #1
    ]);
    ...
    gl.vertexAttribPointer(
      bPosition, dim, gl.FLOAT, false, Float32List.bytesPerElement * 6, Float32List.bytesPerElement * 3);
