...
class ExampleCoordinateSystem extends StatefulWidget {
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<ExampleCoordinateSystem> {
...
void main() {
  ...
  initVertexBuffers(gl) {
    ...
    final model = math.Matrix4.identity()..rotateX(-60.0);
    final view = math.Matrix4.identity()..translate(0.0,10.0,0.0);
